...
## <span style='background-color:#dcffe4'>1. 파이썬 정의</span>
...
## <span style='background-color:#dcffe4'>2. 기본 출력</span>

> 💡 **<span style='color:#f26e08'>print</span>(”내용을 입력하세요”)**

---

## <span style='background-color:#dcffe4'>3. 파이썬 특징</span>
...
## <span style='background-color:#dcffe4'>4. 변수와 대입문</span>
